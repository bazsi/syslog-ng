...
tf_template_call(LogTemplateFunction *self, gpointer s, const LogTemplateInvokeArgs *args, GString *result)
{
  ...
  log_template_append_format_with_context(state->invoked_template, args->super.messages, args->super.num_messages, args->super.opts, args->super.tz, args->super.seq_num, args->super.context_id, result);
}
